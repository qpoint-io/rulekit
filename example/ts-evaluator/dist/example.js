...
console.log("Pass:", rule4.passes({ client_ip: "10.1.2.3" }, { cidr_contains: cidr_contains })); // true
console.log("Fail:", rule4.passes({ client_ip: "192.168.1.1" }, { cidr_contains: cidr_contains })); // false
console.log();
